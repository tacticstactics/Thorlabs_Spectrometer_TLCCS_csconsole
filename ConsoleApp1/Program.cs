...
using System.Text;
using Thorlabs.CCS_Series.interop;

using Thorlabs.CCS_Series;


namespace TLCCSCSConsole
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("TLCCS");


        string instrumentNumber = "0x8089";
        string resourceName = "USB0::0x1313::" + instrumentNumber + "::M" + "00233299" + "::RAW";

           private TLCCS ccsSeries1;

        private device1 = new TLCCS(resourceName, false, false);
